...
func TestRechargeCapacityTierBoundaries(t *testing.T) {
	tests := []struct {
		...
		{-1, 200, 1000}, {0, 200, 1000}, {5000, 200, 1000}, {99999, 200, 1000},
		{100000, 0, 0}, {300000, 0, 0},
	}
...
func TestRechargeCapacityProgress(t *testing.T) {
	...
	require.EqualValues(t, 97250, progress.RemainingCents)
	require.InDelta(t, 0.0275, progress.Progress, 0.0001)
	require.NotNil(t, progress.NextTier)
	require.EqualValues(t, 100000, progress.NextTier.MinimumCents)
