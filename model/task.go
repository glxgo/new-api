...
type TaskBillingContext struct {
	...
	ChannelId           int                `json:"channel_id,omitempty"`             // 最终成功渠道快照
	ChannelCostRatioPPM *int64             `json:"channel_cost_ratio_ppm,omitempty"` // 渠道成本倍率快照
	BillingRequestId    string             `json:"billing_request_id,omitempty"`     // 对应预扣唯一请求键
}
