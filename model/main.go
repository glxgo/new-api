...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&ChannelProbeRecord{},
		&ChannelProbeState{},
		&PelicanControl{}, &PelicanTarget{}, &PelicanRecord{}, &PelicanEvent{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&TokenRouteStep{}, "TokenRouteStep"},
		{&SubscriptionPreConsumeRecord{}, "SubscriptionPreConsumeRecord"},
		{&CustomOAuthProvider{}, "CustomOAuthProvider"},
		{&UserOAuthBinding{}, "UserOAuthBinding"},
		{&PerfMetric{}, "PerfMetric"},
		{&ChannelPerfMetric{}, "ChannelPerfMetric"},
		{&StreamTerminalEvent{}, "StreamTerminalEvent"},
		{&ChannelProbeRecord{}, "ChannelProbeRecord"},
		{&ChannelProbeState{}, "ChannelProbeState"},
		{&CapabilityGroupPresentation{}, "CapabilityGroupPresentation"},
		{&PelicanControl{}, "PelicanControl"}, {&PelicanTarget{}, "PelicanTarget"}, {&PelicanRecord{}, "PelicanRecord"}, {&PelicanEvent{}, "PelicanEvent"},
