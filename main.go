...
func main() {
	...
	// Read-only CPA account quota and model-usage snapshot for the user dashboard.
	service.StartCPAPlatformUsageTask()
	...
	server := gin.New()
	server.Use(gin.CustomRecovery(middleware.RecoverResponse))
