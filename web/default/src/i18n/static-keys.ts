...
export const STATIC_I18N_KEYS = [
  // Request-client names, families and review/variant labels are dynamic.
  'Not recorded',
  'Unknown client',
  'Browser',
  'Client details',
  ...
  'Review failed. Refresh the list and try again.',
  'Group policy',
  'Coding group',
  'Supported clients',
  'Save group policy',
  ...
  'client.variant.desktop',
  'client.variant.cli_tui',
  'client.variant.cli',
  'client.variant.vscode',
  'client.variant.exec',
  'client.variant.sdk',
  'client.variant.acp',
  'client.variant.unspecified',
  'client.variant.versioned',
  'client.variant.unknown_version',
  'client.variant.harness',
  'client.variant.go_inferred',
  'client.variant.python',
  'client.variant.node',
  'client.variant.go',
  'client.variant.runtime',
  'client.variant.browser',
  'client.variant.unknown',
  'Version',
  'Copied',
  'Copy failed',
  'Requests',
