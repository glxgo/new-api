    ...
    <div className='bg-card overflow-hidden rounded-xl border'>
      <div className='grid @5xl/content:grid-cols-[minmax(0,1fr)_19rem]'>
        <div className='flex flex-col gap-3 p-4 sm:p-5'>
          ...
          <StaggerContainer className='grid gap-3 sm:grid-cols-2 @4xl/content:grid-cols-4'>
            {items.map((it) => (
              <StaggerItem
                key={it.key}
                className='bg-card hover:border-primary/25 rounded-lg border p-3 transition-[border-color,transform] duration-200 hover:-translate-y-0.5'
              >
                <StatCard
                  title={it.title}
                  value={it.value}
        ...
        <div className='bg-secondary/55 flex flex-col justify-between gap-4 border-t p-4 sm:p-5 @5xl/content:border-t-0 @5xl/content:border-l'>
          <div className='flex flex-col gap-3'>
            ...
            <div className='font-serif text-2xl font-semibold tracking-[-0.025em] tabular-nums'>
