...
export function getPlanFormSchema(t: TFunction) {
  return z.object({
    ...
    lucky_card_grant_count: z.coerce.number().int().min(0).max(100),
    lucky_card_on_reset: z.boolean(),
...
export function planToFormValues(plan: SubscriptionPlan): PlanFormValues {
  return {
    ...
    lucky_card_grant_count: Number(plan.lucky_card_grant_count || 0),
    lucky_card_on_reset: Boolean(plan.lucky_card_on_reset),
