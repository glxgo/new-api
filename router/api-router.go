...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		pelican := apiRouter.Group("/pelican-archive")
		pelican.Use(func(c *gin.Context) { c.Header("Cache-Control", "no-store"); c.Next() })
		pelican.GET("/groups", middleware.UserAuth(), controller.GetPelicanOverview)
		pelican.GET("/groups/:group_uid/results", middleware.UserAuth(), controller.GetPelicanResults)
		pelican.GET("/records/:id", middleware.UserAuth(), controller.GetPelicanRecord)
		pelican.GET("/records/:id/:kind", middleware.UserAuth(), controller.GetPelicanRecord)
		pelicanAdmin := pelican.Group("/admin", middleware.AdminAuth())
		pelicanAdmin.GET("/control", controller.GetPelicanAdmin)
		pelicanAdmin.PUT("/control", middleware.RootAuth(), controller.UpdatePelicanAdmin)
		pelicanAdmin.POST("/sync", middleware.RootAuth(), controller.SyncPelicanAdmin)
		pelicanAdmin.GET("/preview", controller.GetPelicanPreview)
		pelicanAdmin.GET("/groups/:group_uid/results", controller.GetPelicanPreviewResults)
		pelicanAdmin.GET("/records", controller.GetPelicanAdminRecords)
		pelicanAdmin.GET("/records/:id", controller.GetPelicanAdminRecord)
		pelicanAdmin.GET("/records/:id/:kind", controller.GetPelicanAdminRecord)
